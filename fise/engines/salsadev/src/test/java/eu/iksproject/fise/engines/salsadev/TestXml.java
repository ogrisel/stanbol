...
public class TestXml {
    ...
    public void testSearchDescriptorXml()  {
        ...
        /*JAXBContext jaxbContext = JAXBContext.newInstance(DocumentHitListDto.class, DocumentHitListItemDto.class,
                    DocumentSummaryDto.class, DocumentDto.class, SearchDescriptor.class, ConstrainTerm.class,
                    AtomicTerm.class);
